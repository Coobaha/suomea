...
<div class="flex h-full flex-col px-8 py-4 content">
  ...
  <ol class="mb-4 list list-decimal">
    ...
    <li class="text-gray-700">
      Type in the Finnish, English, or Russian word you would like to search for
      in the text box.
    </li>
    <li class="text-gray-700">
  ...
  <div class="mt-4 text-center lg:w-[60%] mx-auto">
    <p class="text-gray-500">
      ...
      allow for more development and improvement.
    </p>
    <a
