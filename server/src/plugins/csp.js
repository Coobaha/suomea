...
var allowCspImages = function () {
    this.raw.cspAllowAllImages = true;
};
var middleware = helmet_1["default"]({
    contentSecurityPolicy: {
        directives: {
            ...
            'img-src': [function (req, res) { return (res.cspAllowAllImages ? '*' : "'self' data:"); }]
        }
    }
});
exports["default"] = fastify_plugin_1["default"](function (fastify, opts) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        ...
        fastify.addHook('onSend', function (req, reply, payload, done) {
            return middleware(req.raw, reply.raw, function (err) { return done(err, payload); });
        });
